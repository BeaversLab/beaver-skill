...
description: First-time setup flow for beaver-cover-image preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.beaver-skill/beaver-cover-image/EXTEND.md` | Current project |
| User | `~/.beaver-skill/beaver-cover-image/EXTEND.md` | All projects |
