...
description: First-time setup and default model selection flow for beaver-image-gen
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.beaver-skills/beaver-image-gen/EXTEND.md` | Current project |
| User | `$HOME/.beaver-skills/beaver-image-gen/EXTEND.md` | All projects |
