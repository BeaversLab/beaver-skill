...
# Specify style
/beaver-xhs-images posts/ai-future/article.md --style notion

# Specify layout
/beaver-xhs-images posts/ai-future/article.md --layout dense

# Combine style and layout
/beaver-xhs-images posts/ai-future/article.md --style notion --layout list
...
/beaver-xhs-images --style bold --layout comparison
[paste content]
```
