...
async function main() {
  ...
  // Match chunks for this target file (supports both direct name and flattened path)
  ...
  if (chunkFiles.length === 0) {
    console.error(`No chunk files found for "${basename}" in ${chunksDir}`);
    console.error('Expected pattern: <filename>.chunk-001.md, <filename>.chunk-002.md, ...');
    process.exit(1);
  }
